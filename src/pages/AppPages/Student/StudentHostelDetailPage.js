...
function StudentHostelDetailPage() {
  ...
  const handlePreviousImage = () => {
    setCurrentImageIndex((prevIndex) => (prevIndex === 0 ? hostel.images.length - 1 : prevIndex - 1));
  };
    ...
    <div className='admin-hostel-detailpage-container'>
        ...
        <div className='admin-hostel-detailpage-div'>
            <div className='admin-hostel-detailpage-div-images'>
                ...
                <img src={hostel.images?.[0]} alt={`Image ${currentImageIndex}`} />
                    <div className='arrow-button'>
                    <ArrowLeft2 onClick={handlePreviousImage} className='icon-left'/>
                    <ArrowRight2 onClick={handleNextImage} className='icon-right'/>
                    </div>
                </div>
