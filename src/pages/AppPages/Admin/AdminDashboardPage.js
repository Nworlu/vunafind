  ...
  return (
    <div className='admin-dashboard-container'>
      ...
      <div className='admin-dashboard-hostel-container'>
        {hostels.map(hostel=>{
          return (
        <div className='admin-dashboard-hostel-div' key={hostel.id}>
          <div className='admin-dashboard-hostel-img-container'>
            <img src={hostelPic} alt='hostel-pic' />
            <div className='admin-dashboard-available'>
              <p></p>
            <span> {hostel.status}</span>
            </div>
          </div>
          <div className='admin-dashboard-short-des'>
